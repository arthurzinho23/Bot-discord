...
client.on(Events.GuildMemberAdd, async member => {
    try {
        ...
        const icon = isSuspicious ? 'https://i.imgur.com/P3m5H9G.png' : 'https://i.imgur.com/Z4f4k6A.png'; // Exemplo de icones (opcional)
...
client.on(Events.InteractionCreate, async interaction => {
    ...
    try {
        ...
        return interaction.reply({ content: '❌ Alvo não encontrado na base de dados.', ephemeral: true });
    }
    ...
    try {
        ...
        if (action === 'info') {
             ...
             const infoEmbed = new EmbedBuilder()
                ...
                *Nota: O Discord protege a privacidade do usuário, impedindo a listagem de outros servidores que ele participa.*
                `);
