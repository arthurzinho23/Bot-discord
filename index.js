...
const App: React.FC = () => {
  ...
  const [config, setConfig] = useState<BotConfig>({
    ...
    clientId: '',
    guildId: '',
    logChannelId: '1445105097796223078', // Canal de Entrada / Segurança
    exitChannelId: '1445105144869032129', // Canal de Saída
    minAccountAgeDays: 7,
                ...
                <div className="xl:col-span-2 space-y-6">
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">
                                ID do Canal de Entrada (Segurança)
                            </label>
                            <input
                                type="text"
                                value={config.logChannelId}
                                onChange={(e) => setConfig({...config, logChannelId: e.target.value})}
                                placeholder="Ex: 1445105097796223078"
                        ...
                        <div className="flex items-center justify-between bg-blue-900/10 border border-blue-500/20 rounded-lg p-4">
                            ...
                            <span className="text-xs text-blue-400/70">Mantém o bot online 24h em serviços web.</span>
                            </div>
                            <button
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-900 border border-slate-700 rounded-xl p-5">
                        ...
                        <ul className="text-sm text-slate-400 space-y-2 list-disc list-inside">
                            <li>O ID do canal foi atualizado para <code>1445105144869032129</code>.</li>
                            <li>O botão <strong>Expulsar/Banir</strong> gera um log automático no canal.</li>
            ...
            <div className="bg-green-900/20 border border-green-500/30 p-6 rounded-xl flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-100/70">
                  Substitua os arquivos no seu GitHub. O código já contém o sistema <strong>Anti-Sleep</strong> para Render Gratuito.
                </p>
              </div>
            </div>
